...
This dissertation focuses on analyzing the role of decision heuristics in scenarios of risk and uncertainty. 
The studies discussed in this work highlight the importance of considering decision strategies as an important source of variability, and an unavoidable step to study decision making in general.
These strategies not only determine a priori rules for when to stop acquiring information, but they also act as a scaffold for the information search mechanisms. 
These search patterns not only determine the search order and spread during the decision process, but they also can lead to differential valuation of alternatives.
Furthermore, we directly explored the mechanism of information integration by combining data from two different process tracing methods.