...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/study_01/Z1_merged_setup.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/study_01/Z2_decision_models.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/study_01/Z2_scenarios.png}
